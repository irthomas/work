...
badFilelist = []
nFiles = 0
regex = re.compile("201807.._......_.*_SO_A_[IE]_134")

hdf5Files, hdf5Filenames, titles = make_filelist2(regex, file_level, path=r"W:\data\SATELLITE\TRACE-GAS-ORBITER\NOMAD\hdf5")
