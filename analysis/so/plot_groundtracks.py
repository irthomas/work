# -*- coding: utf-8 -*-
"""
Created on Tue May 10 10:51:51 2022
...
from tools.sql.obs_db_functions import get_match_data

from tools.file.hdf5_functions import open_hdf5_file



search_tuple = ("so_ie", {"diffraction_order":[167,170], "longitude":[0.0, 5.0], "latitude":[0.0, 5.0]})


def plot_occultation_tracks(search_tuple):
    ...
    if "longitude" in search_dict.keys() and "latitude" in search_dict.keys():
        ...
        points = plt.scatter(match_dict["longitude"], match_dict["latitude"], c=match_dict["altitude"])
...
def plot_occultation_tracks2(search_tuple, plot_fig=True, save_fig=True):
