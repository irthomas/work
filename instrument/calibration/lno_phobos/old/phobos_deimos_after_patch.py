...
READ LNO PHOBOS 0.3A DATA AFTER FEB 2022 PATCH
...
regex = re.compile("20221222_......_.*_LNO_._P_%i" % diffraction_order)
regex = re.compile("20221222_......_.*_LNO_._P_%i" % diffraction_order)  # Atlas

file_level = "hdf5_level_0p3a"
# file_level = "hdf5_level_0p1d"


hdf5_files, hdf5_filenames, _ = make_filelist(regex, file_level, path=r"C:\Users\iant\Documents\DATA\hdf5")
