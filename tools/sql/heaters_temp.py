"""CODE TAKEN FROM DATA PIPELINE, DB MANIPULATION FUNCTIONS REMOVED"""
...
"""directory containing heaters_temp.db
original file can be found here /bira-iasb/data/SATELLITE/TRACE-GAS-ORBITER/NOMAD/reports/exports/heaters_temp
please make a local copy before using it"""
