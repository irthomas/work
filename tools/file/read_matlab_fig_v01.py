# -*- coding: utf-8 -*-
"""
Created on Wed Jan 22 11:49:35 2020
...
def plotFig(filename,fignr=1):
   d = loadmat(filename,squeeze_me=True, struct_as_record=False,appendmat=False)
   matfig = d['hgS_070000']
   childs = matfig.children
   ax1s = [c for c in childs if c.type == 'axes']
   for ax1 in ax1s:
    #   if(len(ax1) > 0):
    #       ax1 = ax1[0]
...
filename = "PID_pressure_temp_2013-12-19-12-5"
filename = "PID_pressure_temp_2013-11-28-10-44"
filepath = r"C:\Users\iant\Documents\BACKUP\Ox\Datalogger Lab2 (16april2015 full)\plots"
plotFig(os.path.join(filepath, filename+".fig"),fignr=4)