...
from tools.asimut.run_asimut import run_asimut, run_remote_command
...
# h5 = "20220404_022239_1p0a_SO_A_E_134"
h5 = "20220101_005247_1p0a_SO_A_E_136"
...
#write inp file
asimut_inp(h5, indices, aotf_nu, inp_filepath, aotf_filepath_linux, ils_filepath_linux, atmos_filename)
...
local_filepaths = [aotf_filepath, ils_filepath, atmos_filepath, inp_filepath, asi_filepath, sh_filepath]
remote_filepaths = [aotf_filepath_linux, ils_filepath_linux, atmos_filepath_linux, inp_filepath_linux, asi_filepath_linux, sh_filepath_linux]
copy_inputs_to_hera(remote_dirpaths, local_filepaths, remote_filepaths)


#run asimut
run_asimut(sh_filepath_linux)
