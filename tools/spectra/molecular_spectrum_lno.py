...
def get_molecular_hr(molecule, nu_hr):
    ...
    pressures = {"H2O":113.0*1.0e-6*550, "CO2":550.0, "CO":876.0*1.0e-6*550} #previous: 0.24*1.0e3 pressure in Pa
    scaling_factor = {"H2O":1.5, "CO2":20.0, "CO":40.0}
